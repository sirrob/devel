...
//    if($('#re_haslo').val()=='') $('#re_haslo').val('wpisz...');
    ...
    $('input#do2').click(function(){
        ...
        //$('form').jqTransform();
        //setTimeout("$('form').jqTransform()",1000);
        //$(function() { $('#showAdvanced').toggle(function() { $('#sfBlock03').animate({ height: 350 }); }, function() { $('#sfBlock03').animate({ height: 0 }); }); });
    });
...
function fkategoriana(val,url,param)
{
    ...
    //var idx = str.indexOf("?");
    //if(idx >0) str = str.substr(0,idx);
    //window.location='sklep,'+val+'.html';
    //$('#filtered').submit();
