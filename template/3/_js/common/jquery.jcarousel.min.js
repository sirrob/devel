...
(function(g){
    ...
    g.jcarousel=function(a,c){
        ...
        for(var b="",d=a.className.split(" "),f=0;f<d.length;f++)if(d[f].indexOf("jcarousel-skin")!=-1){g(a).removeClass(d[f]);b=d[f];break} 
        ...
        this.funcResize=function(){e.resizeTimer&&clearTimeout(e.resizeTimer);e.resizeTimer=setTimeout(function(){e.reload()},100)};
    ...
    f.fn.extend({setup:function(){
        ...
        for(var b=a;b<=c;b++){var d=this.get(b);if(!d.length||d.hasClass("jcarousel-item-placeholder"))return!1}
        return!0
    }, get:function(a){
        ...
        if(!this.locked&&!this.animating&&this.tail){
            ...
            this.prevLast=this.last;this.animate(c)
        }
    },scroll:function(a,c){
