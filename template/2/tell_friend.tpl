...
<input name="c_" value="wyślij" class="pushb" type="submit"/><input name="c_" value="anuluj" class="pushb" type="button" onclick="opener.focus();window.close();"/>

</form>
<!--/{IT_FORM}-->
<!--{IT_POTWIERDZ}--><br/><br/><center>Wiadomość została wysłana do odbiorcy.</center><br/><br/>
<form action="#"><center><input type="button" onclick="opener.focus();window.close();" value="zamknij &rsaquo;" class="pushb" id="close"/></center></form><!--/{IT_POTWIERDZ}-->
</div>