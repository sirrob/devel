...
<input type="submit" name="s2" value="{T_WYSLIJ}"  class="pushb" style="float:right;" /> 
<input type="button" name="s1" value="{T_WSTECZ}" onclick="window.location='zakup.htm'"class="pushb" style="float:right; margin-right:10px;"/> 
</form>
<!--/{IT_ACTION}-->
{IT_POST_PAY}