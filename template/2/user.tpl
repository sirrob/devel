...
<tr><td>Telefon:</td>
<td><input type="text" name="ko_telefon" id="ko_telefon" value="{KO_TELEFON}" maxlengtd="30"  class="txtm"/> <span>wymagane</span></td>
</tr>
...
<tr><td colspan="2"><input type="checkbox" name="ko_zgoda" id="ko_zgoda" {KO_ZGODA}/>
 TAK, zapoznałem się i akceptuję <a href="cms,40,regulamin.htm" target="_blank">warunki regulaminu</a>.</td>
</tr>
<tr>
	<td colspan="2">
		<input type="checkbox" name="ko_gomezclub" id="ko_gomezclub" {KO_GOMEZCLUB} value="y"> Program Gomez Club - system rabatowy
	</td>
</tr>
</table>
