...
class powiadom extends mb { 
  ...
  global $Cuzytkownik;
    ...
    if(isset($_POST["a"]) and $_POST["a"]=="po"){
      ...
      $this->WYNIK['fo']['po_size'] = $_GET['s'];
      $this->WYNIK["fo"]["po_info"] = "Witam,\nProszę mnie powiadomić kiedy produkt ".$this->WYNIK["fo"]["po_tytul"] . " \nw rozmiarze " . $this->WYNIK['fo']['po_size'] . " będzie dostępny";
      $this->mode = "prn_form";
  ...
  global $_GLOBAL;
    ...
    $M["m_subject"] = "Powiadomienie o dostępności";
    $M["m_to"] = $_GLOBAL["mail_kontakt"];
    //$M["m_to"] = 'maciej@karmac.pl';
