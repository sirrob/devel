...
<head>
    ...
    <link href="http://gomez.pl/template/3/css/looks/screen.css" media="all" rel="stylesheet" type="text/css" /> 
    <link href="http://gomez.pl/template/3/css/looks/print.css" media="print" rel="stylesheet" type="text/css" />
    <link href="http://gomez.pl/template/3/css/common/topnav.css" media="all" rel="stylesheet" type="text/css" />
    <link href="http://gomez.pl/template/3/css/looks/looks.css" media="all" rel="stylesheet" type="text/css" />
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1011367281/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <!--[if !IE 6]><!-->
    <script type="text/javascript" src="http://gomez.pl/template/3/js/looks/gallery.js"></script>
    <script type="text/javascript" src="http://gomez.pl/template/3/js/looks/looks.js"></script>
    <script type="text/javascript">
        StartGalery('{LANG}');
    </script>
    <!--<![endif]-->
