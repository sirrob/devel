...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/index/jcarousel.css" />
    ...
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.jcarousel.min.js" type="text/javascript" charset="utf-8"></script>

    <script src="{URL}template/{TEMPLATE}/js/common/jquery.hoverIntent.minified.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/index/custom.js" type="text/javascript" charset="utf-8"></script>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/3/css/events/jquery.capSlide.css" />	
    <script src="{URL}template/3/js/common/jquery.capSlide.js" type="text/javascript" charset="utf-8"></script>
