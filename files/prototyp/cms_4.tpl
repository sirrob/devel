...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/library/ui/grey/ui.all.css" />
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/cms_3/styles.css" />
    ...
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery-1.7.min.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script src="{URL}template/{TEMPLATE}/_js/common/elastic.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery-ui-1.8.16.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.hoverIntent.minified.js" type="text/javascript" charset="utf-8"></script>

   <script src="{URL}template/{TEMPLATE}/_js/cms_3/custom.js" type="text/javascript" charset="utf-8"></script>
    
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/events/jquery.capSlide.css" />	

    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.capSlide.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script type="text/javascript" src="{URL}template/{TEMPLATE}/_js/common/jquery.jqtransform.js" ></script>
        ...
        <!-- ScrollPane -->
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.jscrollpane.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.mousewheel.js" type="text/javascript" charset="utf-8"></script>
