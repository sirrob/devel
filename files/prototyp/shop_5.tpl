...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/list/styles.css" />

    <link rel="stylesheet" href="{URL}template/{TEMPLATE}/css/fc-webicons.css">

    <script src="{URL}template/{TEMPLATE}/js/common/jquery-1.6.4.min.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script src="{URL}inchtml/script.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/elastic.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery-ui-1.8.16.min.js" type="text/javascript" charset="utf-8"></script>

    <script src="{URL}template/{TEMPLATE}/js/common/jquery.hoverIntent.minified.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/list/custom.js" type="text/javascript" charset="utf-8"></script>
    
<!--    <link rel="stylesheet" type="text/css" media="all" href="template/{TEMPLATE}/css/common/niceforms.css" /> -->

<!--    <script src="template/{TEMPLATE}/js/common/niceforms.js" type="text/javascript" charset="utf-8"></script> -->
    
    <!-- ScrollPane -->
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.jscrollpane.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.mousewheel.js" type="text/javascript" charset="utf-8"></script>
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/product/jscrollpane.description.css" />
    
    <!-- ToolTip -->
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.tooltip.min.js" type="text/javascript" charset="utf-8"></script>
    ...
    <!-- <script type="text/javascript" src="template/{TEMPLATE}/js/common/jquery.js" ></script>-->
                ...
                <div id="header-right-column-container" class="container full-height">
                    ...
                    <div id="cart-box">
                        <div id="cart-content" class="gray-bordered">
                            <div id="cart-header">{T_KOSZYK_W}</div>
                                {KOSZYK_MINI}
                                <!-- 2 produkty za 435,89 zł / <a href="#">Pokaż koszyk</a> -->
                            </div>
			</div><!-- cart-box -->
...
<div id="body" class="unit">
        <div id="body-container" class="container wrapper">
            <div id="breadcrumb">
<!--                Aktualnie znajdujesz się tutaj: <a href="#">kontakt</a> / <a href="#">regulamin</a> /  <span>polityka prywatności</span> -->
<!--{IT_TYTUL}-->{NAZWA}<!--{IT_LOCAL}--><div class="mapa">{T_TU_JESTES}: {LOCAL}</div><!--/{IT_LOCAL}--><!--/{IT_TYTUL}-->
  ...
  <!--  <div id="body" class="unit">
        <div id="body-container" class="container wrapper" style="border: solid 2px red"> -->
<!-- body -->
...
<div class="lewe" style="border: solid 0px red;">
    
     {BOX_SALEMENU} 
<br>    
<div class="menu" id="box21" style="border: solid 1px red;display: none" ><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Nasza oferta</legend></div><!--/{IT_TYTUL}-->
<div id="boxin21" class="menuin" style="{STYLEIN}">
    <div class="menu-element"><label class="menulist"><a href="{URL}sklep,8,kolekcja_meska.htm">kolekcja męska</a></label></div> 
    <div class="menu-element"><label class="menulist"><a href="{URL}sklep,76,kolekcja_damska.htm">kolekcja damska</a></label></div> 
</div><br><br>
<div class="menuend"></div>
</div>

<div class="menu" id="box18" style="display: none"><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Strefa Klienta</legend></div><!--/{IT_TYTUL}-->
<div id="boxin18" class="menuin" style="{STYLEIN}">
<div class="menu-element"><label class="menulist"><a href="{URL}cms,49,formy_platnosci.htm">formy płatności</a></label></div>   
<div class="menu-element"><label class="menulist"><a href="{URL}cms,12,dostawa_towaru.htm">Dostawa towaru</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}cms,15,metody_platnosci.htm">koszty przesyłki</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}cms,51,gwarancje_reklamacje.htm">gwarancje/reklamacje</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}cms,52,zwroty_wymiany.htm">zwroty/wymiany</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}cms,53,rozmiary.htm">wymiary</a></label></div>
...
<div class="newsletter" id="box14" style="display: none"><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Newsletter</legend></div><!--/{IT_TYTUL}-->
<div id="boxin14" class="newsletterin" style="{STYLEIN}">
<span>Chcesz być na bieżąco? Zamów informacje o ofercie bezpośrednio na Twojego maila.</span>
<form action="{URL}cms,47,newseletter.htm" method="post" class="jqTransform">
    <fieldset>
<p><input type="hidden" name="a" value="newsletter" />
<input type="hidden" name="nd_1" value="on" />
<div class="form-element" style="float: left">
    <input type="text" name="ne_email" value="" class="txt" id="news" style="width: 120px;"/>
</div>
<div class="form-element" style="float: left">
            ...
            <div id="footer-columns" class="columns on-5 same-height">
				...
				<div id="copyright-columns" class="columns on-5 same-height">
                                    <div id="copyright-column" class="column span-2">
                                        <div id="copyright-main-container-value" class="container">
