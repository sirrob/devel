...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/common/reset.css" />
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/common/elastic.css" />
    <link rel="stylesheet" type="text/css" media="print" href="{URL}template/{TEMPLATE}/_css/common/elastic.print.css" />

    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/common/theme.css" />
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/common/topnav.css" />

    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/index/styles.css" />
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/index/jcarousel.css" />

    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/library/ui/bordeaux/jquery-ui-1.8.16.slider.css" />
    
    <link rel="stylesheet" href="{URL}template/{TEMPLATE}/_css/fc-webicons.css">

    <script src="{URL}template/{TEMPLATE}/_js/common/jquery-1.6.4.min.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.cookie.js" type="text/javascript" language="javascript" charset="utf-8"></script>    
    <script src="{URL}inchtml/script.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/elastic.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery-ui-1.8.16.min.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.jcarousel.min.js" type="text/javascript" language="javascript" charset="utf-8"></script>

    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.hoverIntent.minified.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/index/custom.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.jqzoom-core-pack.js" type="text/javascript"></script>
    <link rel="stylesheet" href="{URL}template/{TEMPLATE}/_css/product/jquery.jqzoom.css" type="text/css" />  
    
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/3/_css/events/jquery.capSlide.css" />	
    <script src="{URL}template/3/_js/common/jquery.capSlide.js" type="text/javascript" language="javascript" charset="utf-8"></script>

  	<!-- ScrollPane -->
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.jscrollpane.min.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/_js/common/jquery.mousewheel.js" type="text/javascript" language="javascript" charset="utf-8"></script>
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/_css/product/jscrollpane.description.css" />
                
    <!-- jqtransform -->
    <link rel="stylesheet" href="{URL}template/{TEMPLATE}/_css/common/gray.jqtransform.css" type="text/css" media="all" />
    <script type="text/javascript" src="{URL}template/{TEMPLATE}/_js/common/jquery.jqtransform.js" ></script>
    
    <script type="text/javascript" src="{URL}template/{TEMPLATE}/_js/common/js_{LANG}.js" ></script>
    <script type="text/javascript" src="{URL}template/{TEMPLATE}/_js/common/whcookies_{LANG}.js"></script>
        ...
        <div id="header-top-container" class="container wrapper">
                    ...
                    <div id="header-left-column-container" class="container full-height">
                        <div id="logotype">
                            <a href="{URL}" target="_self">
                                <img src="{URL}template/{TEMPLATE}/_images/spacer.gif" width="184" height="69" alt="Gomez"/>
                            </a>
			</div><!-- logotype -->
            ...
            <div id="header-right-column" class="column elastic full-height">
                <div id="header-right-column-container" class="container full-height">
                    <div id="header-breadcrumb"><!-- 9 -->                          <!-- 40 -->                                                 <!-- 47 -->
                    ...
                    <div id="recomend-container" class="container full-height">
                        ...
                        <form id="recomend-form" action="{URL}{LANG}/wyszukiwarka/" method="get" class="jqTransform">
                            <div id="recomend-email-input-container">
                                <input type="text" id="recomend-email-input" name="sna" value="{T_SZUKAJ_Value}" onblur="if(this.value=='')this.value='{T_SZUKAJ_}'" onfocus="if(this.value=='{T_SZUKAJ_}')this.value=''" />
                                <input type="image" src="{URL}template/{TEMPLATE}/_images/but_search.jpg" alt="gomez_club_icon" class="butsearch" />
                            </div>
...
<div class="lewe">
    <div class="menu" id="box18">
        <div id="boxin18" class="menuin" style="{STYLEIN}">
...
<div class="newsletter" id="box14"><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Newsletter</legend></div><!--/{IT_TYTUL}-->
<div id="boxin14" class="newsletterin" style="{STYLEIN}">
<span>{T_NEWSLETTER_DESC}<!-- Chcesz być na bieżąco? Zamów informacje o ofercie bezpośrednio na Twojego maila.--></span>
                    <!-- 47 -->
<form action="{URL}{LANG}/newsletter/" method="post" class="jqTransform">
<p>
    <input type="hidden" name="a" value="newsletter" />
<input type="hidden" name="nd_1" value="on" />
<div class="form-element" style="height: 4px;">
    <input type="text" name="ne_email" value="" class="txt" id="news" style="width: 140px;"/>
</div><br>
<div class="form-element">
    <input type="submit" name="nl_s_1" value="{T_NL_ZAMOW}" class="push"/>
</div>
</p>
</form>
</div><div class="newsletterend"></div>
</div>
</div>
            ...
            <div id="footer-columns" class="columns on-5 same-height">
				...
				<div id="copyright-columns" class="columns on-5 same-height">
                                    ...
                                    <div id="footer-breadcrumb-column" class="column span-3">
                                        <div id="footer-breadcrumb-container" class="container">                <!-- 40 -->                                     <!-- 54 -->
