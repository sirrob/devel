...
<head>
    ...
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.capSlide.js" type="text/javascript" charset="utf-8"></script>
...
<div class="menu" id="box21"><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Nasza oferta</legend></div><!--/{IT_TYTUL}-->
...
<div class="menu" id="box18"><!--{IT_TYTUL}--><div class="box_tytul" onclick="{ONCLICK}" style="{STYLE}"><legend>Strefa Klienta</legend></div><!--/{IT_TYTUL}-->
