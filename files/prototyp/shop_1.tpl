...
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/formy_platnosci/">formy płatności</a></label></div>   
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/dostawa_towaru/">Dostawa towaru</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/metody_platnosci/">koszty przesyłki</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/gwarancje_reklamacje/">gwarancje/reklamacje</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/zwroty_wymiany/">zwroty/wymiany</a></label></div>
<div class="menu-element"><label class="menulist"><a href="{URL}{LANG}/rozmiary/">wymiary</a></label></div>
...
<form action="{URL}{LANG}/newseletter/" method="post" class="jqTransform">
    <fieldset>
