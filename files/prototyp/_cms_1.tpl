...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/index/styles.css"/>
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/index/jcarousel.brands.css"/>
    <link rel="stylesheet" type="text/css" media="all"
          href="{URL}template/{TEMPLATE}/css/index/jcarousel.recommended.css"/>

    <link rel="stylesheet" href="{URL}template/{TEMPLATE}/css/fc-webicons.css">

    <script src="{URL}template/{TEMPLATE}/js/common/jquery-1.7.min.js" type="text/javascript" language="javascript"
            charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.cookie.js" type="text/javascript" language="javascript"
            charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/elastic.js" type="text/javascript" language="javascript"
            charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery-ui-1.8.16.min.js" type="text/javascript"
            language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.jcarousel.min.js" type="text/javascript"
            language="javascript" charset="utf-8"></script>

    <script src="{URL}template/{TEMPLATE}/js/common/jquery.hoverIntent.minified.js" type="text/javascript"
            language="javascript" charset="utf-8"></script>
    <script src="{URL}template/{TEMPLATE}/js/index/custom.js" type="text/javascript" language="javascript"
            charset="utf-8"></script>

    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/events/jquery.capSlide.css"/>
    <script src="{URL}template/{TEMPLATE}/js/common/jquery.capSlide.js" type="text/javascript" language="javascript"
            charset="utf-8"></script>
    ...
    <script type="text/javascript" src="{URL}template/3/js/baner_top/{LANG}/jquery.nivo.slider.js"></script>


    <link rel="stylesheet" href="{URL}template/3/css/baner_top/slider_theme.css" type="text/css" media="screen"/>
    <link rel="stylesheet" href="{URL}template/3/css/baner_top/slider_main.css" type="text/css" media="screen"/>
    <link rel="stylesheet" href="{URL}template/3/css/baner_top/slider_index.css" type="text/css" media="screen"/>
        ...
        <div id="top-columns" class="columns same-height">
            <div id="top-left-column" class="column fixed full-height">
                <div id="top-left-column-container" class="container">
                    ...
                    <a class="fc-webicon facebook small grayed" target="_blank"
                       href="http://www.facebook.com/profile.php?id=170840899634520">Facebook</a>
                    <a class="fc-webicon pinterest small grayed" target="_blank"
                       href="http://pinterest.com/gomezstore/">Pinterest</a>
            ...
            <div id="top-right-column" class="column fixed full-height">
                <div id="top-right-column-container" class="container">
                    <ul id="lang-list">
                        <li><a href="http://gomez.pl/pl/" class="language-button {PL}">PL</a></li>
                        <li><a href="http://gomez.pl/en/" class="language-button">EN</a></li>
                    </ul>
                    {USER_MINI}
                </div>
                <!-- top-right-column-container -->
            </div>
            <!-- top-right-column -->
        </div>
        <!-- top-columns -->
            ...
            <div id="header-right-column" class="column elastic full-height">
                <div id="header-right-column-container" class="container full-height">
                    <div id="header-breadcrumb">
                        <a href="{URL}{LANG}/kontakt/">{T_KONTAKT}<!-- kontakt --></a> / <a
                                href="{URL}{LANG}/regulamin/">{T_REGULAMIN}<!-- regulamin --></a> / <a
                                href="{URL}{LANG}/newsletter/">{T_NEWSLETTER}<!-- newsletter --></a>
                    </div>
                    <!-- header-breadcrumb -->
                    <div id="cart-box">
        ...
        <div id="header-menu-columns" class="columns same-height">
            ...
            <div id="recomend-column" class="column fixed full-height">
                <div id="recomend-container" class="container full-height">
                    <!-- <form id="recomend-form" action="{URL}{LANG}/sklep/szukaj/" method="post" class="jqTransform"> -->
                    <!-- recomentfriend -->
                    <form id="recomend-form" action="{URL}{LANG}/wyszukiwarka/" method="get" class="jqTransform">
                        <div id="recomend-email-input-container">
                            <input type="text" id="recomend-email-input" name="sna" value="{T_SZUKAJ_Value}"
                                   onblur="if(this.value=='')this.value='{T_SZUKAJ_}'"
                                   onfocus="if(this.value=='{T_SZUKAJ_}')this.value=''"/>
                            <input type="image" src="{URL}template/{TEMPLATE}/images/but_search.jpg"
                                   alt="gomez_club_icon" class="butsearch"/>
                        </div>
                        <!-- <input type="image" src="{URL}template/{TEMPLATE}/images/gomez_club_icon.png" alt="gomez_club_icon" /> -->
    ...
    <div id="bottom-button-container" class="container wrapper">
        <div id="bottom-button-columns" class="columns on-6 same-height">
            ...
            <div id="second-bottom-button" class="column bottom-button full-height">
                <a id="second-bottom-button-container" class="container full-height"
                   href="{URL}{LANG}/bezpieczne_zakupy/">
            ...
            <div id="fiveth-bottom-button" class="column bottom-button full-height">
                <a id="fiveth-bottom-button-container" class="container full-height"
                   href="{URL}{LANG}/przesylka_dhl_gratis/">
                    {T_PRZESYLKA_DHL_GRATIS}<!-- Przesyłka<br />DHL Gratis -->
                </a><!-- fiveth-bottom-button-container -->
            </div>
            <!-- fiveth-bottom-button -->
    ...
    <div id="copyright-container" class="container">
        <div id="copyright-columns" class="columns on-5 same-height">
            <div id="copyright-column" class="column span-2">
                <div id="copyright-container" class="container">
                    Copyright © 2010-2013 GOMEZ.PL Created by <a href="http://freshstudio.pl" target="_blank">Fresh
                        Studio</a>
                </div>
            </div>
            <div id="footer-breadcrumb-column" class="column span-3">
                <div id="footer-breadcrumb-container" class="container">
                    <a href="{URL}{LANG}/kontakt/">{T_KONTAKT}<!-- kontakt --></a> / <a href="{URL}{LANG}/regulamin/">
                        {T_REGULAMIN}<!-- regulamin --></a> / <a href="{URL}{LANG}/polityka_prywatnosci/">
                        {T_POLITYKA_PRYWATNOSCI}<!-- polityka prywatności --></a>
                </div>
            </div>
        </div>
        <!-- copyright-columns -->
