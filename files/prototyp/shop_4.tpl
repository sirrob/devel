...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/list/jquery.jscrollpane.css" />
    <link rel="stylesheet" type="text/css" media="all" href="{URL}template/{TEMPLATE}/css/list/jquery.category.css" />
	...
	<link rel="stylesheet" href="{URL}template/{TEMPLATE}/css/common/jslider.css" type="text/css">
	<link rel="stylesheet" href="{URL}template/{TEMPLATE}/css/common/jslider.round.css" type="text/css">
  <!-- end -->

    <!-- bin/jquery.slider.min.js -->
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/jshashtable-2.1_src.js"></script>
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/jquery.numberformatter-1.2.3.js"></script>
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/tmpl.js"></script>
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/jquery.dependClass-0.1.js"></script>
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/draggable-0.1.js"></script>
	<script type="text/javascript" src="{URL}template/{TEMPLATE}/js/common/jquery.slider.js"></script>
  <!-- end -->
...
<div class="lewe" style="width:176px">
